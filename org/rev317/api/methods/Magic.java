...
public final class Magic
{
	...
	public static enum StandardMagic377 implements SpellBook
	{
		WIND_STRIKE(570, 239, 1), CONFUSE(593, 239, 3), WATER_STRIKE(616, 239, 5), LEVEL_1_ENCHANT(639, 239, 7), EARTH_STRIKE(662, 239, 9), WEAKEN(685, 239, 11), FIRE_STRIKE(708, 239, 13), BONES_TO_BANANAS(570, 264, 15), WIND_BOLT(593, 264, 17), CURSE(616, 264, 19), BIND(639, 264, 20), LOW_LEVEL_ALCHEMY(662, 264, 21), WATER_BOLT(685, 264, 23), EDGEVILLE_TELEPORT(708, 264, 25), LEVEL_2_ENCHANT(570, 286, 27), EARTH_BOLT(593, 286, 29), COMBAT_TRAINING_TELEPORT(616, 286, 31), TELEKINETIC_GRAB(639, 286, 33), FIRE_BOLT(662, 286, 35), SKILLING_TELEPORT(685, 286, 37), CRUMBLE_UNDEAD(708, 286, 39), WIND_BLAST(570, 310, 41), SUPERHEAT_ITEM(593, 310, 43), CITIES(616, 310, 45), WATER_BLAST(639, 310, 47), LEVEL_3_ENCHANT(662, 310, 49), IBAN_BLAST(685, 310, 50), SNARE(708, 310, 50), MAGIC_DART(570, 335, 50), MINIGAMES(593, 335, 51), EARTH_BLAST(616, 335, 53), HIGH_LEVEL_ALCHEMY(639, 335, 55), CHARGE_WATER_ORB(662, 335, 56), LEVEL_4_ENCHANT(685, 335, 57), MONSTERS(708, 335, 58), FIRE_BLAST(570, 360, 59), CHARGE_EARTH_ORB(593, 360, 60), BONES_TO_PEACHES(616, 360, 60), SARADOMIN_STRIKE(639, 360, 60), CLAWS_OF_GUTHIX(662, 360, 60), FLAMES_OF_ZAMORAK(685, 360, 60), DONATOR_AND_PREMIUM(708, 360, 61), WIND_WAVE(570, 385, 62), CHARGE_FIRE_ORB(593, 385, 63), HONORS(616, 385, 64), WATER_WAVE(639, 385, 65), CHARGE_AIR_ORB(662, 385, 66), VULNERABILITY(685, 385, 66), LEVEL_5_ENCHANT(708, 385, 68), EARTH_WAVE(570, 408, 70), ENFEEBLE(593, 408, 73), TELEOTHER_LUMBRIDGE(616, 408, 74), FIRE_WAVE(639, 408, 75), ENTANGE(662, 408, 79), STUN(685, 408, 80), CHARGE(708, 408, 80), TELEOTHER_FALADOR(570, 432, 82), TELE_BLOCK(593, 432, 85), LEVEL_6_ENCHANT(616, 432, 87), TELEOTHER_CAMELOT(639, 432, 90);
	...
	public static final void clickSpell(SpellBook spell) {
		...
		Time.sleep(500);
		Mouse.getInstance().click(new Point(spell.getX()+10, spell.getY()));
	}
